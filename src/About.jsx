...
function AboutUs() {
  return (
    <div className="about-us-container">
      <h1 style={{fontSize:"25px"}} className="about-us-heading">About Us</h1>
      <p style={{fontSize:"18px"}} className="about-us-description">Welcome to Paradise Nursery, where green meets serenity!</p>
      <p style={{fontSize:"18px"}} className="about-us-content">
