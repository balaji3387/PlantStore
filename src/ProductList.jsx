    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                <div className='x'> <a href="#" onClick={(e)=>handlePlantsClick(e)} style={styleA}>Plants</a></div>
        ...
        {showPlants?(<div><Plants plantsArray={plantsArray}/></div>):(<div></div>)}
        {showCart?(<div><CartItem onContinueShopping={handleContinueShopping}/></div>):(<div></div>)}
